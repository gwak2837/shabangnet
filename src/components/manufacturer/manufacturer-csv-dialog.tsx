...
export function ManufacturerCsvDialog({ open, onOpenChange }: ManufacturerCsvDialogProps) {
  const [state, formAction, isPending] = useFormAction<ManufacturerCsvImportResult | null, FormData>(
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <form action={formAction} className="flex flex-col gap-3" encType="multipart/form-data">
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-slate-900" htmlFor="manufacturer-csv">
              CSV 파일
            </label>
            <Input
              accept=".csv,text/csv"
